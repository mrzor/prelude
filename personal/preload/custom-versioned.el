...
(custom-set-variables
 ...
 '(rm-text-properties
   '(("\\` Ovwrt\\'" 'face 'font-lock-warning-face)
     ("\\` Parinfer:.+\\'" 'face 'sml/minor-modes-hl)))
...
(custom-set-faces
 ...
 '(font-lock-builtin-face ((t (:foreground "#2bb1ad"))))
 ...
 '(helm-buffer-process ((t (:extend t :foreground "Sienna3" :height 0.8))))
 '(helm-buffer-size ((t (:extend t :foreground "green yellow"))))
 ...
 '(helm-non-file-buffer ((t (:inherit italic :extend t :foreground "white smoke"))))
 '(helm-selection ((t (:extend t :background "#020e0c"))))
 '(helm-source-header ((t (:extend t :background "#7aa0b8" :foreground "#22343f" :weight bold :height 1.3 :family "Latin Modern Mono Caps"))))
 '(helm-visible-mark ((t (:extend t :background "medium sea green" :foreground "black"))))
 ...
 '(minibuffer-prompt ((t (:foreground "pale turquoise" :weight semi-bold :height 139))))
